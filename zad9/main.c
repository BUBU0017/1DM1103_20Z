...
char *url = "http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/info/qwerty_3";
make_request(url);
}

void move(char *token) {
char *url = "http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/move/qwerty_3";
make_request(url);
}

void explore(char *token) {
char *url = "http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/explore/qwerty_3";
make_request(url);
}

void left(char *token) {
char *url = "http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/rotate/qwerty_3/left";
make_request(url);
}

void right(char *token) {
char *url = "http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/rotate/qwerty_16/right";
make_request(url);
}
